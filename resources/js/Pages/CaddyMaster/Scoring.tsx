...
export default function CaddyMasterScoring({ group, groupCode, players, holes, existingScores, tournamentId }: Props) {
    ...
    const handleConfirmScores = () => {
        ...
        setConfirming(true);
        router.post(route('caddie-master.confirm', group.id), { confirmed_by_name: confirmedName }, {
                            ...
                            <div className="px-6 py-4 border-t border-border space-y-3">
                                <div>
                                    ...
                                    <input
                                        ...
                                        placeholder="Nom du caddie master"
